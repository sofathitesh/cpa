...
function getFCColor_Countries() 
{
	//accessing the global variables
	global $FC_ColorCounter_country;
	global $arr_FCColors;
	
	//Update index
	$FC_ColorCounter_country++;
	//Return color
	return($arr_FCColors[$FC_ColorCounter_country % count($arr_FCColors)]);
}
?>