...
//This script will count gw required offers to be completed, also set gateway as complete when required offers are complete for this gateway. 

if(isset($_REQUEST['oid']) && !empty($gid)){
	
	

  $offer_id = makesafe($_REQUEST['oid']);
