...
$oid = makesafe($_REQUEST['offer_id']);

$status = 1; //makesafe($_REQUEST['status']);

$subID = makesafe($_REQUEST['tracking_id']);

$network = 'CPAGrip';

$password = 'CPNNETWORK';  //Change this password of your choice. keep it same as specified in postback URL.
...
if(!empty($isGW))
{
    ...
    require_once("../assets/CPANX_GWS_WIDGSPostbacks/cpagrip_postback.php");
	return;
