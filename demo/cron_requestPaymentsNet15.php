...
$sql1 = mysql_query("SELECT uid, balance, email_address, payment_cycle, payment_method, payment_method_details FROM users WHERE balance >= $min_limit AND payment_cycle IS NOT NULL AND payment_method IS NOT NULL AND payment_method_details IS NOT NULL AND payment_cycle = '$paymentCycle'");
