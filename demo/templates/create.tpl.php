...
<div class="tabs">
    <div {if $st eq '' || $st eq 1}class="active_tab"{else}class="tab"{/if} id="gw_basic"><p>Basic Appearance</p></div>
    <div {if $st eq 2}class="active_tab"{else}class="tab"{/if} id="gw_advance"><p>Advanced Appearance</p></div>
    <div {if $st eq 3}class="active_tab"{else}class="tab"{/if} id="gw_general"><p>General Settings</p></div>        
</div>
...
<div class="gw_field">
    ...
    <div class="clear">
    <div class="gw_txtarea"><textarea  name="gw_title" class="input nice" onkeyup="countChars('title')" id="gw_title"  >{if $gw_title eq ""}Example Header Text{else} {$gw_title}{/if}</textarea></div>
...
<div class="gw_field">
    ...
    <div class="clear">
    <div class="gw_txtarea"><textarea name="instructions" class="input" onkeyup="countChars('instructions')" id="instructions" >{if $instructions eq ""} To access this area of our website, please complete the easy requirements below. It will only take a minute and our site will automatically unlock when you're finished.{else}{$instructions}{/if}</textarea></div>
...
<input type="text"  id="targeted_countries"  name="targeted_countries" class="select_target_countries form-control" style="width:300px;" />
...
<div class="gw_field">
    ...
    <input type="image" src="templates/images/gw_save_btn.jpg" alt="Save Gateway" name="saveBtn" onmouseover="this.src='templates/images/gw_save_btn_hover.jpg'" onmouseout="this.src='templates/images/gw_save_btn.jpg'" />
